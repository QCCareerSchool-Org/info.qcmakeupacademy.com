      ...
      <div className="container text-center">
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-12 col-md-10 col-lg-4">
            ...
            <span>Once you complete your assignments and have graduated from your course, you'll receive your Master Makeup certification! You'll have lifetime access to course materials, as well as a 50% off enrollment discount for all additional courses.</span>
          </div>
        </div>
      </div>
    </section>

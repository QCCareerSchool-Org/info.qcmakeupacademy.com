  ...
  return (
    <footer className="bg-linen-dark py-12 px-6 border-t border-charcoal/10">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col items-center lg:flex-row gap-6 font-sans text-sm text-charcoal/60 uppercase tracking-widest">
      ...
      <div className="max-w-6xl mx-auto">
        <div className={styles.reCaptchaDisclaimer}>
